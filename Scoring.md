...
A risk matrix is a diagram we have used before with sucess. A qualitative risk-analysis method of evaluating risk is not an unusal method of showing, an evaluating risk analysis. (Kilde: https://www.safran.com/content/introduction-qualitative-risk-analysis).

Important points with a risk matrix is multiple, and some of these are;
